...
import {
  ...
  isDeepSeekV4Model,
} from "@praxis-ai/praxis/modelAdapter/providerAccessLayer/modelMetadataRegistry";
import { loadResolvedEmbeddingConfig, type RaxodeResolvedEmbeddingConfig } from "../config/raxode-config.js";
import { resolveCacheDir } from "../runtime/runtime-paths.js";
...
export function buildEmbeddingModelAvailabilityScopeKey(
  config: Pick<RaxodeResolvedEmbeddingConfig, "baseURL" | "apiKey" | "authProfileId">,
): string {
...
export async function probeEmbeddingModelAvailability(
  modelId: RaxodeResolvedEmbeddingConfig["model"],
