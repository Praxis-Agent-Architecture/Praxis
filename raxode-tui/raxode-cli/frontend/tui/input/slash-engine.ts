...
export const DEFAULT_PRAXIS_SLASH_COMMANDS: PraxisSlashCommand[] = [
  ...
  { id: "rush", name: "rush", description: "Rush toward the goal at a faster speed.", hidden: true },
  { id: "exit", name: "exit", aliases: ["quit"], description: "Exit the current session" },
  { id: "cmp", name: "cmp", description: "View current context sections summary", hidden: true },
  { id: "mp", name: "mp", description: "Browse current memory state", hidden: true },
  { id: "capabilities", name: "capabilities", description: "View registered TAP capabilities", hidden: true },
