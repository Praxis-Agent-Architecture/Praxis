...
const AGENT_FAMILY: CapabilityFamilyDefinition = {
  tapFamilyKey: "agent",
  tapFamilyTitle: "Agent",
  familyKey: "agent",
  familyTitle: "Agent",
};
...
export function resolveCapabilityFamilyDefinition(
  ...
  if (
    ...
    || normalized === "file.search"
    || normalized === "file.write"
    || normalized === "file.edit"
    || normalized === "patch.apply"
  ...
  if (
    normalized === "skill.load"
    || normalized === "context.load"
  ...
  if (normalized === "plan.update" || normalized === "write_todos" || normalized === "tracker.create") {
