...
export type RaxodeMemoryProfile = "off" | "readonly" | "appendOnly" | "full";
...
export type RaxodeOptions = {
  ...
  memoryProfile?: RaxodeMemoryProfile;
  memoryPromptGuide?: string;
};
...
export function normalizeRaxodeOptions(options: RaxodeOptions = {}): NormalizedRaxodeOptions {
  return {
    policyProfile: options.policyProfile ?? "permissive",
    ...
    memoryProfile: options.memoryProfile ?? "readonly",
    memoryPromptGuide: options.memoryPromptGuide ?? "",
  };
}
