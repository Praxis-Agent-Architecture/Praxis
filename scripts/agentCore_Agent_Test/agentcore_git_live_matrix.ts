...
const gitLiveCases: readonly GitLiveCase[] = [
  ...
  },
  {
    ...
    userPrompt: "看一下 scripts/agentCore_Agent_Test/agentcore_tool_lab.ts 第 1 行是谁改的。",
    input: { target: { repositoryPath: "/repo/project", filePath: "scripts/agentCore_Agent_Test/agentcore_tool_lab.ts", range: { startLine: 1, endLine: 1 } }, context },
    expectedCalls: ["/repo/project:blame --line-porcelain -L 1,1 -- scripts/agentCore_Agent_Test/agentcore_tool_lab.ts"],
  },
  {
