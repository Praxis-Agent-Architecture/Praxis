...
本文是当前 `Praxis_Agent_Architecture/src/agentCore/` 工程骨架的总指导文件。
...
所以后续工作必须围绕 `Praxis_Agent_Architecture/src/agentCore/` 这套结构推进，而不是回到旧文档切片体系里。
