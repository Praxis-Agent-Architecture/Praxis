...
> 对应源码：`Praxis_Agent_Architecture/src/agentCore/agent_runtimeImplementation/runtime.execEngine/baseToolExecutorPortFactory.ts`
...
- 不要在 factory 内实现 175 个 tool 的语义。
- 不要替 TAP 做高级工具策略。
