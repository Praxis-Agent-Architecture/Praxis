...
const matrixScripts: readonly MatrixScript[] = [
  {
    family: "shell",
    path: "examples/scripts/agentcore_shell_live_matrix.ts",
    coveragePaths: ["examples/scripts/shellFullCapabilities.ts"],
  },
  { family: "git", path: "examples/scripts/agentcore_git_live_matrix.ts" },
  { family: "code", path: "examples/scripts/agentcore_codebase_explore_live_matrix.ts" },
  { family: "skill", path: "examples/scripts/agentcore_skill_live_matrix.ts" },
  { family: "omni", path: "examples/scripts/agentcore_omni_live_matrix.ts" },
  { family: "computeruse", path: "examples/scripts/agentcore_computeruse_live_matrix.ts" },
  { family: "search", path: "examples/scripts/agentcore_search_live_matrix.ts" },
  { family: "mcp", path: "examples/scripts/agentcore_mcp_live_matrix.ts" },
] as const;
