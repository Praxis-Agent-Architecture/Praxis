...
import { createAgentRuntimeInstanceSnapshot } from "../../../src/runtimeImplementation/agentRuntimeInstance.js";

defineAgentCoreContractTest({
  sourcePath: "src/runtimeImplementation/agentRuntimeInstance.ts",
