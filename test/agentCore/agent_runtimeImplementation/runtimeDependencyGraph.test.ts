...
import { buildRuntimeDependencyGraph } from "../../../src/agentCore_runtimeImplementation/runtimeDependencyGraph.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_runtimeImplementation/runtimeDependencyGraph.ts",
