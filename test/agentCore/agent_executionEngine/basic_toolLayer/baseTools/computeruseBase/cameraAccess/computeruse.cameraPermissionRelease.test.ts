...
defineAgentCoreContractTest({
  sourcePath: "src/agentCore/agent_executionEngine/basic_toolLayer/baseTools/computeruseBase/cameraAccess/computeruse.cameraPermissionRelease.ts",
...
test("computeruse.cameraPermissionRelease keeps canonical storage shape and operational doc boundary", () => {
  ...
  const entryText = readFileSync(
    path.join(repoRoot, "src/agentCore/agent_executionEngine/basic_toolLayer/baseTools/computeruseBase/cameraAccess/computeruse.cameraPermissionRelease.ts"),
    "utf8",
  );
