...
} from "../../../../../../../src/executionEngine/basic_toolLayer/baseTools/gitBase/commit/git.amendLastCommit.js";

defineAgentCoreContractTest({
  sourcePath: "src/executionEngine/basic_toolLayer/baseTools/gitBase/commit/git.amendLastCommit.ts",
