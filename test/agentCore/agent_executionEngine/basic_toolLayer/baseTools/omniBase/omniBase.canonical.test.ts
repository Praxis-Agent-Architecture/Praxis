...
import { planAudioCompression, omniAudioCompressionDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/audioTransformer/omni.audioCompressor.js";
import { planAudioFormatConversion, omniAudioFormatConversionDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/audioTransformer/omni.audioFormatConversion.js";
import { planAudioLyricsGeneration, omniAudioLyricsGenerationDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/audioTransformer/omni.audioLyricsGeneration.js";
import { planGenerateAudio, omniGenerateAudioDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/audioTransformer/omni.generateAudio.js";
import { planListenAudio, omniListenAudioDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/audioTransformer/omni.listenAudio.js";
import { planGenerateImage, omniGenerateImageDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.generateImage.js";
import { planImageCompressor, omniImageCompressorDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.imageCompressor.js";
import { planImageFormatConversion, omniImageFormatConversionDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.imageFormatConversion.js";
import { planGenerateVideo, omniGenerateVideoDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/videoTransformer/omni.generateVideo.js";
import { planVideoCompressor, omniVideoCompressorDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/videoTransformer/omni.videoCompressor.js";
import { planVideoFormatConversion, omniVideoFormatConversionDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/videoTransformer/omni.videoFormatConversion.js";
import { planVideoSubtitleGeneration, omniVideoSubtitleGenerationDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/videoTransformer/omni.videoSubtitleGeneration.js";
import { planViewVideo, omniViewVideoDescriptor } from "../../../../../../src/executionEngine/basic_toolLayer/baseTools/omniBase/videoTransformer/omni.viewVideo.js";
...
for (const tool of tools) {
  defineAgentCoreContractTest({
    sourcePath: 'src/executionEngine/basic_toolLayer/baseTools/omniBase/' + tool.group + '/' + tool.id + '.ts',
...
test('omniBase remaining tools keep canonical storage shape and thin explicit entry exports', () => {
  for (const tool of tools) {
    ...
    const entryText = readFileSync(path.join(repoRoot, 'src/executionEngine/basic_toolLayer/baseTools/omniBase', tool.group, tool.id + '.ts'), 'utf8');
