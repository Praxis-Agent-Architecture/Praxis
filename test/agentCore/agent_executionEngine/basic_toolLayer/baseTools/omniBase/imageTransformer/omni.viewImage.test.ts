...
import {
  ...
  planOmniViewImage,
} from "../../../../../../../src/agentCore_executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.viewImage.js";

const testDir = path.dirname(fileURLToPath(import.meta.url));
const repoRoot = path.resolve(testDir, "../../../../../../..");

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.viewImage.ts",
...
test("omni.viewImage keeps canonical storage shape and thin explicit entry exports", () => {
  ...
  const entryText = readFileSync(
    path.join(repoRoot, "src/agentCore_executionEngine/basic_toolLayer/baseTools/omniBase/imageTransformer/omni.viewImage.ts"),
    "utf8",
  );
