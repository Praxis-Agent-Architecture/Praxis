...
import { exposeTextOutput } from "../../../../../src/executionEngine/IOTransceiver/outputExposer/textExposer.js";

defineAgentCoreContractTest({
  sourcePath: "src/executionEngine/IOTransceiver/outputExposer/textExposer.ts",
