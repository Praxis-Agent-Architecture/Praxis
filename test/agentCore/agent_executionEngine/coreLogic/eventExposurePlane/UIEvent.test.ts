...
import { exposeUIEvent, uiEventDescriptor } from "../../../../../src/executionEngine/coreLogic/eventExposurePlane/UIEvent.js";

defineAgentCoreContractTest({
  sourcePath: "src/executionEngine/coreLogic/eventExposurePlane/UIEvent.ts",
