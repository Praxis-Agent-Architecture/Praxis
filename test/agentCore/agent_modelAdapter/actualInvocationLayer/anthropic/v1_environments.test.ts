...
} from "../../../../../src/modelAdapter/actualInvocationLayer/anthropic/v1_environments.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/anthropic/v1_environments.ts",
