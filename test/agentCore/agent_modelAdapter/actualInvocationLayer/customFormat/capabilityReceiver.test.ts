...
} from "../../../../../src/agentCore_modelAdapter/actualInvocationLayer/customFormat/capabilityReceiver.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/actualInvocationLayer/customFormat/capabilityReceiver.ts",
