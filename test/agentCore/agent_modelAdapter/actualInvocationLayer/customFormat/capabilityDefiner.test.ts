...
} from "../../../../../src/modelAdapter/actualInvocationLayer/customFormat/capabilityDefiner.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/customFormat/capabilityDefiner.ts",
