...
} from "../../../../../src/modelAdapter/actualInvocationLayer/deepmind/v1beta_models_countTokens.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/deepmind/v1beta_models_countTokens.ts",
