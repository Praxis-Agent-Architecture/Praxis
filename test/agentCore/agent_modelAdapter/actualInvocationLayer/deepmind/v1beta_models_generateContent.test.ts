...
} from "../../../../../src/modelAdapter/actualInvocationLayer/deepmind/v1beta_models_generateContent.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/deepmind/v1beta_models_generateContent.ts",
