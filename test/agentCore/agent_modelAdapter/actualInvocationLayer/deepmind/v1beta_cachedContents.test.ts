...
} from "../../../../../src/modelAdapter/actualInvocationLayer/deepmind/v1beta_cachedContents.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/deepmind/v1beta_cachedContents.ts",
