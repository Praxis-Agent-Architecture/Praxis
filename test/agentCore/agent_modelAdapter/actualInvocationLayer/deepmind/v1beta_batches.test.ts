...
} from "../../../../../src/agentCore_modelAdapter/actualInvocationLayer/deepmind/v1beta_batches.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/actualInvocationLayer/deepmind/v1beta_batches.ts",
  docPath: "docs/agentCore/agent_modelAdapter/actualInvocationLayer/deepmind/v1beta_batches.md",
