...
} from "../../../../../src/modelAdapter/actualInvocationLayer/deepmind/v1beta_fileSearchStores.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/deepmind/v1beta_fileSearchStores.ts",
