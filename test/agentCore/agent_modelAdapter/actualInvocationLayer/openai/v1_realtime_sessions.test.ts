...
} from "../../../../../src/modelAdapter/actualInvocationLayer/openai/v1_realtime_sessions.js";

defineAgentCoreContractTest({
  sourcePath: "src/modelAdapter/actualInvocationLayer/openai/v1_realtime_sessions.ts",
