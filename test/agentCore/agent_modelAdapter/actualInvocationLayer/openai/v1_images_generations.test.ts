...
} from "../../../../../src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_images_generations.js";
...
defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_images_generations.ts",
