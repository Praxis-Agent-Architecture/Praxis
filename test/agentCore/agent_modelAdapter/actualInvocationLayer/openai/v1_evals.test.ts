...
import {
  ...
  invokeOpenAIV1Evals,
} from "../../../../../src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_evals.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_evals.ts",
