...
} from "../../../../../src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_chatkit_threads.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/actualInvocationLayer/openai/v1_chatkit_threads.ts",
