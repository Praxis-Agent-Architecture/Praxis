...
} from "../../../../src/agentCore_modelAdapter/abstractionLayer/harnessReceiverInterface.js";

defineAgentCoreContractTest({
  sourcePath: "src/agentCore_modelAdapter/abstractionLayer/harnessReceiverInterface.ts",
