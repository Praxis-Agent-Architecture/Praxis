...
defineAgentCoreContractTest({
  sourcePath: "src/toolabilityPool/officeBase/presentations/office.slidesRead.ts",
  docPath: "docs/toolabilityPool/officeBase/presentations/office.slidesRead.md",
