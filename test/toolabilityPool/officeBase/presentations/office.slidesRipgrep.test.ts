...
defineAgentCoreContractTest({
  sourcePath: "src/toolabilityPool/officeBase/presentations/office.slidesRipgrep.ts",
  docPath: "docs/toolabilityPool/officeBase/presentations/office.slidesRipgrep.md",
