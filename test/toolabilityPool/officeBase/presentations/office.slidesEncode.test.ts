...
defineAgentCoreContractTest({
  sourcePath: "src/toolabilityPool/officeBase/presentations/office.slidesEncode.ts",
  docPath: "docs/toolabilityPool/officeBase/presentations/office.slidesEncode.md",
