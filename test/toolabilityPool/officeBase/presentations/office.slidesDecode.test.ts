...
defineAgentCoreContractTest({
  sourcePath: "src/toolabilityPool/officeBase/presentations/office.slidesDecode.ts",
  docPath: "docs/toolabilityPool/officeBase/presentations/office.slidesDecode.md",
