 ...
 * 核心目的：把 175 个 BaseTool 的模型可读说明组织成可折叠、可展开、可加权的 PromptPack capability 材料。
 * 边界：这里只构造上下文说明，不执行工具、不替代 provider tool schema、不绕过 registry/handler/executor。
 */

import { existsSync, readFileSync } from "node:fs";

import type { PromptPackMaterialDraft } from "../../agent_executionEngine/promptPack/promptDefiner.js";
