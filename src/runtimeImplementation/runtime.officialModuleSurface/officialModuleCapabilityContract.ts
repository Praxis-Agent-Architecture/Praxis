...
> = {
  ...
  multiagent: [
    ...
    { capabilityId: "runtime.agent.message", channels: ["invoke"] },
    { capabilityId: "runtime.agent.inbox", channels: ["invoke"] },
    { capabilityId: "runtime.agent.wait", channels: ["invoke"] },
    { capabilityId: "runtime.agent.stop", channels: ["invoke"] },
    { capabilityId: "runtime.agent.kill", channels: ["invoke"] },
    { capabilityId: "runtime.agent.list", channels: ["read"] },
    { capabilityId: "runtime.agent.inspect", channels: ["read"] },
