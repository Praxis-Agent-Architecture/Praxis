...
> 对应源码：`src/agentCore/agent_executionEngine/basic_toolLayer/baseTools/gitBase/stash/git.stashChanges.ts`
> 对应实现：`src/storagePool/baseToolStorage/gitBase/stash/git.stashChanges/`
